...
public class MainNavigateTabBar extends LinearLayout implements View.OnClickListener {
    ...
    public MainNavigateTabBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNormalTextColor = (tabTextColor != null ? tabTextColor : context.getResources().getColorStateList(R.color.text_unselect));


        if (selectedTabTextColor != null) {
            mSelectedTextColor = selectedTabTextColor;
        } else {
            mSelectedTextColor = context.getResources().getColorStateList(R.color.text_selected);
        }

        mViewHolderList = new ArrayList<ViewHolder>();
    }

    public void addBundle(Bundle bandle){
        this.dataBundle = bandle;
    }
...
//        }
    ...
    protected void onAttachedToWindow() {
        ...
        mFragmentActivity = (Activity) getContext();
